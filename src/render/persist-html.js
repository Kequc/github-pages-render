...
async function persistHtml (config, location, name, md, template, partials = {}, pkg = {}) {
    ...
    const html = mustache.render(template, Object.assign({}, config.view, { content, pkg }), partials);
